...
import static org.hamcrest.Matchers.hasValue;
    ...
    public class ProductCRUDTest extends TestBase {
        static String name ="Duracell50"+ TestUtils.getRandomValue();
        static String type ="max";
        static String upc ="ABCD";
        static String model ="AAB";
        static int price = 13;
        static int shipping = 28;
        static  String description ="small";
        static  String manufacturer = "Phillips";
