...
public class StoreCRUDTest extends TestBase {
    static String name ="Diuesh Roman"+ TestUtils.getRandomValue();
    static String type ="Electric General";
    static String address="115,Wembley Street";
    static String address2="Midlands";
    static String city="Wembley"+TestUtils.getRandomValue();
    static String state="Brent";
    static String zip="HA0 4TH";
    static Integer lat =100;
    static Integer lng =200;
    static String hours ="12:15";
    static int id;
    @Steps
    ...
    public void test001() {
        ...
        servicesData.put("name","Diuesh Div");
